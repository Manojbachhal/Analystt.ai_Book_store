...
function Navbar() {
    return (
        <Flex zIndex="99999" position="fixed" mb="5" width="100%" background="#cec9bf" top="0" justifyContent="space-evenly" alignItems="center" boxShadow=" rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px" >
            ...
            <h1 style={{ color: '#015A62', fontWeight: 'bold' }}> <Link to="/cart">Cart</Link></h1>
        </Flex >
    )
}
